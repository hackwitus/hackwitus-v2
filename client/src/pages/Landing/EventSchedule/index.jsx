  ...
  return (
    <div className="event-schedule">
      <div className="event-schedule__upper">
        <h1 className="event-schedule__title">
          <span
            role="img"
        ...
        <div className="event-schedule__selector">
          <button
            className={`event-schedule__day ${
              day === '6' ? 'event-schedule__day--active' : ''
            }`}
            value="6"
            onClick={handleClick}
          >
          ...
          <button
            className={`event-schedule__day ${
              day === '0' ? 'event-schedule__day--active' : ''
            }`}
            value="0"
            onClick={handleClick}
          >
      ...
      <div className="event-schedule__list">{renderEvents()}</div>
    </div>
  );
};
